...
function Clock() {
    ...
    const stringTime = `${date.getHours() < 10 ? '0' + date.getHours() : date.getHours()}:${date.getMonth() < 10 ? '0' + date.getMonth() : date.getMonth()}:${date.getMinutes() < 10 ? '0' + date.getMinutes() : date.getMinutes()}` || <br /> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
